...
public class KinesisAppender extends AbstractWriterAppender<WriterManager> {

  private static final KinesisManagerFactory MANAGER_FACTORY = new KinesisManagerFactory();
  ...
  public static KinesisAppender createAppender(
    ...
    return new KinesisAppender(name, filter, layout,
        WriterManager.getManager(streamName, params, MANAGER_FACTORY));
  }

  private KinesisAppender(final String name, final Filter filter, final StringLayout layout,
